...
echo "Hint: Custom binds could be declared in '~/.config/wechat/binds.list', each line a path, absolute or relative to your HOME"
BWRAP_CUSTOM_BINDS=()
...
BWRAP_ARGS=(
    ...
    --ro-bind /{usr/share/wechat/usr/bin,sandbox}/dde-file-manager
    ...
    --ro-bind {/usr/share/wechat,}/usr/lib/license
    --ro-bind {/usr/share/wechat,}/var/
    --ro-bind {/usr/share/wechat,}/etc/os-release
    --ro-bind {/usr/share/wechat,}/etc/lsb-release
